...
const motivos = [
    {
        ...
        paragraph:
            "Todas nuestras clases siguen protocolos de seguridad rigurosos",
        bgColor: "bg-blue-50",
    ...
    },
    {
        ...
        paragraph:
            "Nuestros instructores tienen años de experiencia y certificaciones internacionales.",
        bgColor: "bg-green-50",
    ...
    },
    {
        ...
        paragraph:
            "Utilizamos tablas y trajes de neopreno de marcas líderes en el mercado.",
...
const seccionesRapidas = [
    { label: "Clases de Surf", href: "/servicios/surf" },
    { label: "Surftrips", href: "/servicios/surf-trips" },
    { label: "Surfskate", href: "/servicios/surf-skate" },
    { label: "Tienda", href: "/tienda" },
    { label: "Taquillas", href: "/taquilla/planes" },
                ...
                <div className="max-w-6xl mx-auto rounded-3xl border border-slate-200/80 bg-white/90 p-6 shadow-xl shadow-slate-200/60 backdrop-blur-sm sm:p-8 lg:p-10">
                    <div className="flex flex-col items-center gap-10 lg:flex-row lg:gap-16">
                        ...
                        <div className="w-full space-y-6 lg:w-3/5">
                            ...
                            <h1
                                id="hero-heading"
                                className="font-heading text-4xl sm:text-5xl md:text-6xl font-extrabold leading-tight text-slate-900"
                            >
                                Domina el Cantábrico con S4
                            </h1>

                            <p className="max-w-xl text-sm sm:text-base md:text-lg text-slate-800">
                                San Sebastian Surf School: tu seguridad, nuestra
                                ...
                                , con instructores locales que conocen cada pico
                                del Cantábrico.
                            </p>
                            ...
                            <div className="mt-8 grid grid-cols-1 gap-4 text-sm sm:grid-cols-3">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-slate-600">
                                                Formación oficial y rescate en
                                                mar
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p className="font-semibold text-slate-900">
                                                +5.000 surfistas formados
                                            </p>
                                            <p className="text-xs text-slate-600">
                                                Clases para todos los niveles y
                                                edades
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between text-xs text-surf-sand sm:text-sm">
                                        ...
                                        <div className="text-right">
                                            <p className="font-semibold">
                                                Condiciones Cantábrico
                                            </p>
                                            <p className="text-surf-sand/80">
                                                Seguridad &amp; técnica primero
                                            </p>
                                        </div>
                                    </div>
                                </div>
            ...
            <section className="mt-16 sm:mt-20 mb-12">
                <div className="max-w-5xl mx-auto text-center">
                    ...
                    <p className="text-sm sm:text-base text-slate-700 mb-8">
                        Más de{" "}
                        <span className="font-semibold">5.000 alumnos</span> han
                        confiado en San Sebastian Surf School para dar su primer
                ...
                <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
                    <article className="glass-card rounded-2xl p-6 shadow-xl transition-s4 hover:-translate-y-1 hover:shadow-2xl text-left">
                        <p className="text-sm text-slate-700 mb-4">
                            “Sentí que conocían cada ola de Zurriola. Fui con
                            respeto al mar y salí con confianza y muchas ganas
                            de volver.”
                        </p>
                        <p className="text-xs font-semibold text-surf-primary">
                            Ane · Nivel Iniciación
                        </p>
                    </article>
                    <article className="glass-card rounded-2xl p-6 shadow-xl transition-s4 hover:-translate-y-1 hover:shadow-2xl text-left">
                        <p className="text-sm text-slate-700 mb-4">
                            “La combinación de seguridad, técnica y material
                            hizo que mis hijos disfrutaran sin riesgos. Se nota
                            que son escuela oficial.”
                        </p>
                        <p className="text-xs font-semibold text-surf-primary">
                            Jon · Padre de dos alumnos
                        </p>
                    </article>
                    <article className="glass-card rounded-2xl p-6 shadow-xl transition-s4 hover:-translate-y-1 hover:shadow-2xl text-left">
                        <p className="text-sm text-slate-700 mb-4">
                            “Venía con experiencia en otras playas y me
                            sorprendió el conocimiento local del Cantábrico.
                            Clases muy personalizadas.”
                        </p>
                        <p className="text-xs font-semibold text-surf-primary">
                            Laura · Intermedio
                        </p>
