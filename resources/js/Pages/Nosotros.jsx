    ...
    const contactOptions = useMemo(() => {
        ...
        if (whatsappHref) {
            options.push({
                ...
                icon: WHATSAPP_OPTION_ICON,
            });
        }
        return [...options, ...CONTACT_OPTIONS_STATIC];
    }, [whatsappHref, props.academyWhatsappDisplay]);
        ...
        >
            ...
            <div className="relative w-full max-w-sm overflow-hidden rounded-3xl border border-white/10 bg-slate-900/95 shadow-2xl">
                ...
                <div className="flex flex-col gap-2 p-4">
                    {contactOptions.map(({ id, label, sub, href, bg, iconBg, icon }) => (
                        <a
                            key={id}
                            href={href}
