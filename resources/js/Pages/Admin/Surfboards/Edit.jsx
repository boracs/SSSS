...
export default function Edit({ surfboard, priceSchemas }) {
                ...
                >
                    ...
                    <label className="block">
                        ...
                        <div className="mt-2 text-xs text-slate-500">
                            Si subes archivo, se reemplaza la imagen anterior.
                        </div>
                    </label>
