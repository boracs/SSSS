            ...
            <div className="mx-auto w-full max-w-3xl px-4 py-8 sm:px-6">
                ...
                <form onSubmit={handleSubmit} encType="multipart/form-data">
                    <div className="space-y-5 rounded-2xl border border-white/10 bg-white/5 p-6">
                        ...
                        <Field label="Reemplazar imágenes (opcional)" error={errors["images.0"]}>
                            ...
                            <p className="mt-1 text-xs text-slate-500">Si subes nuevas imágenes se eliminarán las anteriores.</p>
                        </Field>
                    </div>
