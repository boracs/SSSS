    ...
    return (
        <span className="flex min-w-0 max-w-full items-start gap-1" title={row.label}>
            <span
                ...
                aria-hidden="true"
            />
            <span className="min-w-0 flex-1 text-[11px] font-semibold leading-[1.15] tracking-tight text-slate-900 sm:text-sm sm:leading-snug sm:tracking-normal">
                {wrapsOnMobile ? (
                    <>
...
export default function RentalTariffTable({ tariffTable }) {
    ...
    return (
        <section
            ...
            className="mb-6 rounded-3xl border border-slate-200 bg-white p-5 shadow-sm ring-1 ring-slate-200 sm:p-6"
        >
            <header>
                <h2
                    id="rental-tariffs-heading"
                    className="font-heading text-2xl font-extrabold tracking-tight text-slate-900 sm:text-[28px]"
                >
                    Tarifas de alquiler
                </h2>
            ...
            <div className="mt-6 border-t border-slate-200 pt-5">
                <div className="flex flex-wrap items-center gap-2">
                    <Shirt className="h-4 w-4 shrink-0 text-slate-500" aria-hidden="true" />
                    <h3 className="font-heading text-base font-bold text-slate-900">Neopreno</h3>
                </div>
            ...
            {notes.length > 1 ? (
                <ul className="mt-5 space-y-1.5 border-t border-slate-200 pt-4 text-xs leading-relaxed text-slate-500">
            ...
            <div className="mt-5 flex justify-center border-t border-slate-200 pt-5">
                <a
                    ...
                    className="inline-flex items-center gap-2 rounded-xl bg-cyan-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-cyan-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400 focus-visible:ring-offset-2 focus-visible:ring-offset-white"
                >
