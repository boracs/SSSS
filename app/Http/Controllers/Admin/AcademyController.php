...
class AcademyController extends Controller
{
    ...
    /**
     * Legacy: el Dashboard Global quedó obsoleto (cobro = Stripe + datáfono).
     * Redirige al panel operativo de Pagos.
     */
    public function globalPaymentsDashboard()
    {
        return redirect()->route('admin.payments.datafono.index');
    }
