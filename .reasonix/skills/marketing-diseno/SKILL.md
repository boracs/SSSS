...
1. **Lee el archivo completo** y adopta el rol, los 10 principios, las skills S1–S11, las reglas duras R1–R9, la rúbrica ponderada y el formato de salida estándar exactamente como se especifican.
...
4. Entrega con el **formato de salida estándar** del agente: diagnóstico (nota según rúbrica) → puntos fuertes → tabla de hallazgos priorizados (ID | Dónde | Problema | Por qué importa | Esfuerzo) → quick wins → plan de rediseño → decisión ejecutiva.
