...
return [
    'pages' => [
        ...
        [
            ...
            'summary' => 'Reparación de neoprenos: percha exclusiva + pizarra + marcar zonas (X); Willy recoge en viajes a Zarautz (~2–3/mes), devuelve con precio; pago en metálico en su buzón. Puedes fijar tope de precio o consultarle antes.',
            'keywords' => 'willy neopreno traje wetsuit percha pizarra buzon reparacion costura rotura zarautz tope precio',
            'patterns' => [
        ...
        [
            ...
            'summary' => 'Clases de surfskate en el club S4: individual, grupal y packs; entrenamiento de técnica fuera del agua.',
            'keywords' => 'surf skate sk8 entrenamiento tierra carver clase precio',
            'patterns' => [
                '/\b(clase|clases|precio|tarifas?|entrenamient\w*)\b.*\b(surf\s*skate|surfskate)\b/u',
                '/\b(surf\s*skate|surfskate)\b.*\b(clase|clases|precio|tarifas?)\b/u',
        ...
        [
            ...
            'summary' => 'Elegir surfskate YOW según altura, peso y posture: wheelbase (clave), perfiles, tabla de selección, concave/ancho/cola; protección en clase. Medidas orientativas.',
            'keywords' => 'surfskate guia tabla altura peso yow meraki wheelbase equipamiento snappers chiba pipe grom malibu teahupoo',
            'patterns' => [
                '/\b(surfskate|surf\s*skate).*(guia|tabla|altura|peso|equipamiento|yow|meraki|wheelbase|eje|ejes|medida)\b/u',
                '/\b(que\s+surfskate|cual\s+surfskate|elegir\s+surfskate|recomienda\w*\s+surfskate)\b/u',
                '/\b(wheelbase|distancia\s+entre\s+ejes|grom|snappers|chiba|pipe|meraki)\b/u',
            ],
            'priority' => 12,
        ],
        [
        ...
        [
            ...
            'summary' => 'Bonos de sesión en Zurriola con reportaje fotográfico (5–80 €). Fotos en condiciones reales: sin garantía de salir en todas las tomas. Reserva por contacto.',
            'keywords' => 'fotos fotografia sesion water photographer reportaje bono zurriola recuerdo',
            'patterns' => [
                '/\b(fotos?|fotografia|fotografo|reportaje)\b.*\b(surf|sesion|agua|ola|zurriola)\b/u',
                '/\b(fotos?|fotografia)\b.*\b(bono|precio|tarifa|reserv\w*)\b/u',
                '/\b(bono)\b.*\b(fotos?|fotografia)\b/u',
            ],
            'priority' => 10,
        ],
        [
